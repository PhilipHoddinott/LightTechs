...
ratio=.471;
	...
	//this runs the steering servo loop as normal when the slide switch is on
...
void Drive_Motor(void){
	if (range<=10) {
		...
		//MOTOR_PW = 2028+(23* PW_DIFF_SC)/26;//MOTOR_PW = 2028+(read_AD_input(4)* 147)/26;
		result = read_AD_input(4);	//adjust speed based on potentiometer
		MOTOR_PW = 2028+result*5.8;
