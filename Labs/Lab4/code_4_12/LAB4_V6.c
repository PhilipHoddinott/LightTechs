...
unsigned int AD_DIFF_SC =255;	//AD range
unsigned int PW_DIFF_SC = (PW_MAX_SC -PW_MIN_SC);//PW range
unsigned int PW_SC=0;//INPUT PW value


unsigned char h_count = 0;//compas counter
unsigned char r_count = 0;//ranger counter
THIS IS NOT USED!!!!!!!!!!!!!!!!unsigned int counts = 0;//count for the print statments
unsigned char new_print =0; //flag for printing
unsigned int Counts=0, n_Counts=0;
...
signed int  heading; 	//direction of travel
signed int desired_heading;
unsigned int  range; 	//how far away is the next object
unsigned int keypad;
