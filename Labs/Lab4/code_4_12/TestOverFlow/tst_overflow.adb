...
S:Ltst_overflow.lcd_print$fmt$1$75({3}DG,SC:S),B,1,-5
S:Ltst_overflow.lcd_print$len$1$76({1}SC:U),R,0,0,[r6]
S:Ltst_overflow.lcd_print$i$1$76({1}SC:U),R,0,0,[r7]
S:Ltst_overflow.lcd_print$ap$1$76({1}DD,SC:U),R,0,0,[]
...
S:Ltst_overflow.getchar$c$1$39({1}SC:S),R,0,0,[]
S:Ltst_overflow.getchar_nw$c$1$41({1}SC:S),R,0,0,[]
S:Ltst_overflow.lcd_clear$NumBytes$1$80({1}SC:U),E,0,0
S:Ltst_overflow.lcd_clear$Cmd$1$80({2}DA2d,SC:U),E,0,0
S:Ltst_overflow.read_keypad$i$1$81({1}SC:U),E,0,0
S:Ltst_overflow.read_keypad$Data$1$81({2}DA2d,SC:U),E,0,0
S:Ltst_overflow.kpd_input$mode$1$83({1}SC:S),R,0,0,[r7]
S:Ltst_overflow.kpd_input$sum$1$84({2}SI:U),R,0,0,[r5,r6]
S:Ltst_overflow.kpd_input$key$1$84({1}SC:S),R,0,0,[r3]
S:Ltst_overflow.kpd_input$i$1$84({1}SC:S),R,0,0,[r7]
S:Ltst_overflow.i2c_write_data$start_reg$1$100({1}SC:U),E,0,0
S:Ltst_overflow.i2c_write_data$buffer$1$100({3}DG,SC:U),E,0,0
S:Ltst_overflow.i2c_write_data$num_bytes$1$100({1}SC:U),E,0,0
S:Ltst_overflow.i2c_write_data$addr$1$100({1}SC:U),R,0,0,[r7]
S:Ltst_overflow.i2c_write_data$i$1$101({1}SC:U),R,0,0,[r7]
S:Ltst_overflow.i2c_read_data$start_reg$1$102({1}SC:U),E,0,0
S:Ltst_overflow.i2c_read_data$buffer$1$102({3}DG,SC:U),E,0,0
S:Ltst_overflow.i2c_read_data$num_bytes$1$102({1}SC:U),E,0,0
S:Ltst_overflow.i2c_read_data$addr$1$102({1}SC:U),R,0,0,[r7]
S:Ltst_overflow.i2c_read_data$j$1$103({1}SC:U),R,0,0,[r7]
S:Ltst_overflow.Accel_Init$Data2$1$106({1}DA1d,SC:U),E,0,0
S:G$MOTOR_PW$0$0({2}SI:U),E,0,0
S:G$inputA$0$0({1}SC:S),E,0,0
S:Ltst_overflow.lcd_print$text$1$76({80}DA80d,SC:U),F,0,0
...
S:Ftst_overflow$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:Ftst_overflow$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:Ftst_overflow$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:Ftst_overflow$__str_3$0$0({17}DA17d,SC:S),D,0,0
S:Ftst_overflow$__str_4$0$0({27}DA27d,SC:S),D,0,0
