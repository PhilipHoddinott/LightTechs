...
; This file was generated Tue Apr 12 17:39:58 2016
;--------------------------------------------------------
	.module tst_overflow
...
;--------------------------------------------------------
	.area DSEG    (DATA)
Ltst_overflow.lcd_clear$NumBytes$1$80==.
_lcd_clear_NumBytes_1_80:
	.ds 1
Ltst_overflow.lcd_clear$Cmd$1$80==.
_lcd_clear_Cmd_1_80:
	.ds 2
Ltst_overflow.read_keypad$i$1$81==.
_read_keypad_i_1_81:
	.ds 1
Ltst_overflow.read_keypad$Data$1$81==.
_read_keypad_Data_1_81:
	.ds 2
Ltst_overflow.i2c_write_data$start_reg$1$100==.
_i2c_write_data_PARM_2:
	.ds 1
Ltst_overflow.i2c_write_data$buffer$1$100==.
_i2c_write_data_PARM_3:
	.ds 3
Ltst_overflow.i2c_write_data$num_bytes$1$100==.
_i2c_write_data_PARM_4:
	.ds 1
Ltst_overflow.i2c_read_data$start_reg$1$102==.
_i2c_read_data_PARM_2:
	.ds 1
Ltst_overflow.i2c_read_data$buffer$1$102==.
_i2c_read_data_PARM_3:
	.ds 3
Ltst_overflow.i2c_read_data$num_bytes$1$102==.
_i2c_read_data_PARM_4:
	.ds 1
Ltst_overflow.Accel_Init$Data2$1$106==.
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
Ltst_overflow.lcd_print$text$1$76==.
...
;--------------------------------------------------------
	...
	C$tst_overflow.c$8$1$108 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:8: char inputA=0;
	mov	_inputA,#0x00
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$tst_overflow.c$11$1$106 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:11: void main(void){
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$tst_overflow.c$12$1$108 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:12: Sys_Init();	//All init function
	lcall	_Sys_Init
	C$tst_overflow.c$13$1$108 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:13: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$tst_overflow.c$16$1$108 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:16: while(1){
00102$:
	C$tst_overflow.c$17$2$109 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:17: printf("\n\rEnter input: \t");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$tst_overflow.c$19$2$109 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:19: inputA=getchar();
	lcall	_getchar
	mov	_inputA,dpl
	C$tst_overflow.c$21$2$109 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:21: MOTOR_PW = 2028+(20*inputA*147)/26;
	mov	a,_inputA
	...
	addc	a,b
	mov	(_MOTOR_PW + 1),a
	C$tst_overflow.c$22$2$109 ==.
;	C:\Users\hoddip\Documents\GitHub\LightTechs\Labs\Lab4\code_4_12\TestOverFlow\tst_overflow.c:22: printf("\n\r20*in*147=%d, MOTOR = %d",(20*inputA*147), MOTOR_PW);
	push	_MOTOR_PW
	push	(_MOTOR_PW + 1)
	push	ar6
	push	ar7
	...
	mov	sp,a
	sjmp	00102$
	C$tst_overflow.c$25$1$108 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
Ftst_overflow$__str_0$0$0 == .
___str_0:
	.db 0x0A
	.ascii "Type digits; end w/#"
	.db 0x00
Ftst_overflow$__str_1$0$0 == .
___str_1:
	.ascii "     %c%c%c%c%c"
	.db 0x00
Ftst_overflow$__str_2$0$0 == .
___str_2:
	.ascii "%c"
	.db 0x00
Ftst_overflow$__str_3$0$0 == .
___str_3:
	.db 0x0A
	.db 0x0D
	.ascii "Enter input: "
	.db 0x09
	.db 0x00
Ftst_overflow$__str_4$0$0 == .
___str_4:
	.db 0x0A
	.db 0x0D
	.ascii "20*in*147=%d, MOTOR = %d"
	.db 0x00
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
