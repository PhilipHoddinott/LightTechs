...
S:LLAB4_V45_TESTCODE.lcd_print$fmt$1$75({3}DG,SC:S),B,1,-5
S:LLAB4_V45_TESTCODE.lcd_print$len$1$76({1}SC:U),R,0,0,[r6]
S:LLAB4_V45_TESTCODE.lcd_print$i$1$76({1}SC:U),R,0,0,[r7]
S:LLAB4_V45_TESTCODE.lcd_print$ap$1$76({1}DD,SC:U),R,0,0,[]
...
S:LLAB4_V45_TESTCODE.getchar$c$1$39({1}SC:S),R,0,0,[]
S:LLAB4_V45_TESTCODE.getchar_nw$c$1$41({1}SC:S),R,0,0,[]
S:LLAB4_V45_TESTCODE.lcd_clear$NumBytes$1$80({1}SC:U),E,0,0
S:LLAB4_V45_TESTCODE.lcd_clear$Cmd$1$80({2}DA2d,SC:U),E,0,0
S:LLAB4_V45_TESTCODE.read_keypad$i$1$81({1}SC:U),E,0,0
S:LLAB4_V45_TESTCODE.read_keypad$Data$1$81({2}DA2d,SC:U),E,0,0
S:LLAB4_V45_TESTCODE.kpd_input$mode$1$83({1}SC:S),R,0,0,[r7]
S:LLAB4_V45_TESTCODE.kpd_input$sum$1$84({2}SI:U),R,0,0,[r5,r6]
S:LLAB4_V45_TESTCODE.kpd_input$key$1$84({1}SC:S),R,0,0,[r3]
S:LLAB4_V45_TESTCODE.kpd_input$i$1$84({1}SC:S),R,0,0,[r7]
S:LLAB4_V45_TESTCODE.i2c_write_data$start_reg$1$100({1}SC:U),E,0,0
S:LLAB4_V45_TESTCODE.i2c_write_data$buffer$1$100({3}DG,SC:U),E,0,0
S:LLAB4_V45_TESTCODE.i2c_write_data$num_bytes$1$100({1}SC:U),E,0,0
S:LLAB4_V45_TESTCODE.i2c_write_data$addr$1$100({1}SC:U),R,0,0,[r7]
S:LLAB4_V45_TESTCODE.i2c_write_data$i$1$101({1}SC:U),R,0,0,[r7]
S:LLAB4_V45_TESTCODE.i2c_read_data$start_reg$1$102({1}SC:U),E,0,0
S:LLAB4_V45_TESTCODE.i2c_read_data$buffer$1$102({3}DG,SC:U),E,0,0
S:LLAB4_V45_TESTCODE.i2c_read_data$num_bytes$1$102({1}SC:U),E,0,0
S:LLAB4_V45_TESTCODE.i2c_read_data$addr$1$102({1}SC:U),R,0,0,[r7]
S:LLAB4_V45_TESTCODE.i2c_read_data$j$1$103({1}SC:U),R,0,0,[r7]
S:LLAB4_V45_TESTCODE.Accel_Init$Data2$1$106({1}DA1d,SC:U),E,0,0
...
S:LLAB4_V45_TESTCODE.lcd_print$text$1$76({80}DA80d,SC:U),F,0,0
...
S:G$start_ping$0$0({2}DF,SV:S),C,0,0
S:FLAB4_V45_TESTCODE$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_3$0$0({15}DA15d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_4$0$0({16}DA16d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_5$0$0({65}DA65d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_6$0$0({36}DA36d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_7$0$0({13}DA13d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_8$0$0({10}DA10d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_9$0$0({12}DA12d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_10$0$0({52}DA52d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_11$0$0({13}DA13d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_12$0$0({19}DA19d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_13$0$0({49}DA49d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_14$0$0({50}DA50d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_15$0$0({48}DA48d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_16$0$0({32}DA32d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_17$0$0({20}DA20d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_18$0$0({20}DA20d,SC:S),D,0,0
S:FLAB4_V45_TESTCODE$__str_19$0$0({20}DA20d,SC:S),D,0,0
