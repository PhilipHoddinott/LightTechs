...
S:LLAB3_2RangerCompass_V3.lcd_print$fmt$1$75({3}DG,SC:S),B,1,-5
S:LLAB3_2RangerCompass_V3.lcd_print$len$1$76({1}SC:U),R,0,0,[r6]
S:LLAB3_2RangerCompass_V3.lcd_print$i$1$76({1}SC:U),R,0,0,[r7]
S:LLAB3_2RangerCompass_V3.lcd_print$ap$1$76({1}DD,SC:U),R,0,0,[]
...
S:LLAB3_2RangerCompass_V3.getchar$c$1$10({1}SC:S),R,0,0,[]
S:LLAB3_2RangerCompass_V3.getchar_nw$c$1$12({1}SC:S),R,0,0,[]
S:LLAB3_2RangerCompass_V3.lcd_clear$NumBytes$1$80({1}SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.lcd_clear$Cmd$1$80({2}DA2d,SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.read_keypad$i$1$81({1}SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.read_keypad$Data$1$81({2}DA2d,SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.kpd_input$mode$1$83({1}SC:S),R,0,0,[r7]
S:LLAB3_2RangerCompass_V3.kpd_input$sum$1$84({2}SI:U),R,0,0,[r5,r6]
S:LLAB3_2RangerCompass_V3.kpd_input$key$1$84({1}SC:S),R,0,0,[r3]
S:LLAB3_2RangerCompass_V3.kpd_input$i$1$84({1}SC:S),R,0,0,[r7]
S:LLAB3_2RangerCompass_V3.i2c_write_data$start_reg$1$100({1}SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.i2c_write_data$buffer$1$100({3}DG,SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.i2c_write_data$num_bytes$1$100({1}SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.i2c_write_data$addr$1$100({1}SC:U),R,0,0,[r7]
S:LLAB3_2RangerCompass_V3.i2c_write_data$i$1$101({1}SC:U),R,0,0,[r7]
S:LLAB3_2RangerCompass_V3.i2c_read_data$start_reg$1$102({1}SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.i2c_read_data$buffer$1$102({3}DG,SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.i2c_read_data$num_bytes$1$102({1}SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.i2c_read_data$addr$1$102({1}SC:U),R,0,0,[r7]
S:LLAB3_2RangerCompass_V3.i2c_read_data$j$1$103({1}SC:U),R,0,0,[r7]
S:LLAB3_2RangerCompass_V3.Accel_Init$Data2$1$106({1}DA1d,SC:U),E,0,0
...
S:G$comp_Data$0$0({2}DA2d,SC:U),E,0,0
S:G$range_addr$0$0({1}SC:U),E,0,0
S:G$range_Data$0$0({2}DA2d,SC:U),E,0,0
S:G$ping_addr$0$0({1}SC:U),E,0,0
S:G$ping_Data$0$0({1}DA1d,SC:U),E,0,0
S:LLAB3_2RangerCompass_V3.lcd_print$text$1$76({80}DA80d,SC:U),F,0,0
...
S:FLAB3_2RangerCompass_V3$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_3$0$0({51}DA51d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_4$0$0({15}DA15d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_5$0$0({2}DA2d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_6$0$0({3}DA3d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_7$0$0({2}DA2d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_8$0$0({3}DA3d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_9$0$0({2}DA2d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_10$0$0({3}DA3d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_11$0$0({2}DA2d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_12$0$0({3}DA3d,SC:S),D,0,0
S:FLAB3_2RangerCompass_V3$__str_13$0$0({33}DA33d,SC:S),D,0,0
