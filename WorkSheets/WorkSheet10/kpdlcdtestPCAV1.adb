...
S:LkpdlcdtestPCAV1.lcd_print$fmt$1$75({3}DG,SC:S),B,1,-5
S:LkpdlcdtestPCAV1.lcd_print$len$1$76({1}SC:U),R,0,0,[r6]
S:LkpdlcdtestPCAV1.lcd_print$i$1$76({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCAV1.lcd_print$ap$1$76({1}DD,SC:U),R,0,0,[]
...
F:G$normal_operation$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$kpd_input_zero$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$kpd_input_one$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$two_key_input$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$philip_read_keyboard$0$0({2}DF,SC:S),Z,0,0,0,0,0
...
S:LkpdlcdtestPCAV1.getchar$c$1$39({1}SC:S),R,0,0,[]
S:LkpdlcdtestPCAV1.getchar_nw$c$1$41({1}SC:S),R,0,0,[]
S:LkpdlcdtestPCAV1.lcd_clear$NumBytes$1$80({1}SC:U),E,0,0
S:LkpdlcdtestPCAV1.lcd_clear$Cmd$1$80({2}DA2d,SC:U),E,0,0
S:LkpdlcdtestPCAV1.read_keypad$i$1$81({1}SC:U),E,0,0
S:LkpdlcdtestPCAV1.read_keypad$Data$1$81({2}DA2d,SC:U),E,0,0
S:LkpdlcdtestPCAV1.kpd_input$mode$1$83({1}SC:S),R,0,0,[r7]
S:LkpdlcdtestPCAV1.kpd_input$sum$1$84({2}SI:U),R,0,0,[r5,r6]
S:LkpdlcdtestPCAV1.kpd_input$key$1$84({1}SC:S),R,0,0,[r3]
S:LkpdlcdtestPCAV1.kpd_input$i$1$84({1}SC:S),R,0,0,[r7]
S:LkpdlcdtestPCAV1.i2c_write_data$start_reg$1$100({1}SC:U),E,0,0
S:LkpdlcdtestPCAV1.i2c_write_data$buffer$1$100({3}DG,SC:U),E,0,0
S:LkpdlcdtestPCAV1.i2c_write_data$num_bytes$1$100({1}SC:U),E,0,0
S:LkpdlcdtestPCAV1.i2c_write_data$addr$1$100({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCAV1.i2c_write_data$i$1$101({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCAV1.i2c_read_data$start_reg$1$102({1}SC:U),E,0,0
S:LkpdlcdtestPCAV1.i2c_read_data$buffer$1$102({3}DG,SC:U),E,0,0
S:LkpdlcdtestPCAV1.i2c_read_data$num_bytes$1$102({1}SC:U),E,0,0
S:LkpdlcdtestPCAV1.i2c_read_data$addr$1$102({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCAV1.i2c_read_data$j$1$103({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCAV1.Accel_Init$Data2$1$106({1}DA1d,SC:U),E,0,0
S:G$Counts$0$0({2}SI:U),E,0,0
S:G$nCounts$0$0({2}SI:U),E,0,0
S:G$nOverflows$0$0({2}SI:U),E,0,0
S:LkpdlcdtestPCAV1.normal_operation$keypad$1$123({1}SC:S),R,0,0,[r7]
S:LkpdlcdtestPCAV1.kpd_input_zero$keypad$1$127({1}SC:S),R,0,0,[r6]
S:LkpdlcdtestPCAV1.kpd_input_one$keypad$1$131({1}SC:S),R,0,0,[r6]
S:LkpdlcdtestPCAV1.two_key_input$keypad1$1$135({1}SC:S),R,0,0,[r7]
S:LkpdlcdtestPCAV1.two_key_input$keypad2$1$135({1}SC:S),R,0,0,[r6]
S:LkpdlcdtestPCAV1.two_key_input$result$1$135({1}SC:S),R,0,0,[r5]
S:LkpdlcdtestPCAV1.philip_read_keyboard$keypad$1$137({1}SC:S),R,0,0,[r6]
S:LkpdlcdtestPCAV1.philip_read_keyboard$keypad_prime$1$137({1}SC:S),R,0,0,[r7]
S:LkpdlcdtestPCAV1.lcd_print$text$1$76({80}DA80d,SC:U),F,0,0
...
S:FkpdlcdtestPCAV1$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_3$0$0({9}DA9d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_4$0$0({14}DA14d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_5$0$0({29}DA29d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_6$0$0({58}DA58d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_7$0$0({29}DA29d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_8$0$0({30}DA30d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_9$0$0({37}DA37d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_10$0$0({30}DA30d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_11$0$0({44}DA44d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_12$0$0({15}DA15d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_13$0$0({22}DA22d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_14$0$0({30}DA30d,SC:S),D,0,0
S:FkpdlcdtestPCAV1$__str_15$0$0({32}DA32d,SC:S),D,0,0
