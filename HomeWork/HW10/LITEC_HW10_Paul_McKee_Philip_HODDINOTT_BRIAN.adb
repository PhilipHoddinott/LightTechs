M:LITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN
...
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.lcd_print$fmt$1$75({3}DG,SC:S),B,1,-5
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.lcd_print$len$1$76({1}SC:U),R,0,0,[r6]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.lcd_print$i$1$76({1}SC:U),R,0,0,[r7]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.lcd_print$ap$1$76({1}DD,SC:U),R,0,0,[]
...
F:G$print_output$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ReadCompassChar$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$ReadCompassInt$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$ReadRangerChar0$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$ReadRangerChar1$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$start_ping$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.getchar$c$1$10({1}SC:S),R,0,0,[]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.getchar_nw$c$1$12({1}SC:S),R,0,0,[]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.lcd_clear$NumBytes$1$80({1}SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.lcd_clear$Cmd$1$80({2}DA2d,SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.read_keypad$i$1$81({1}SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.read_keypad$Data$1$81({2}DA2d,SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.kpd_input$mode$1$83({1}SC:S),R,0,0,[r7]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.kpd_input$sum$1$84({2}SI:U),R,0,0,[r5,r6]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.kpd_input$key$1$84({1}SC:S),R,0,0,[r3]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.kpd_input$i$1$84({1}SC:S),R,0,0,[r7]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_write_data$start_reg$1$100({1}SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_write_data$buffer$1$100({3}DG,SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_write_data$num_bytes$1$100({1}SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_write_data$addr$1$100({1}SC:U),R,0,0,[r7]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_write_data$i$1$101({1}SC:U),R,0,0,[r7]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_read_data$start_reg$1$102({1}SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_read_data$buffer$1$102({3}DG,SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_read_data$num_bytes$1$102({1}SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_read_data$addr$1$102({1}SC:U),R,0,0,[r7]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.i2c_read_data$j$1$103({1}SC:U),R,0,0,[r7]
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.Accel_Init$Data2$1$106({1}DA1d,SC:U),E,0,0
...
S:G$compass_char$0$0({1}SC:U),E,0,0
S:G$compass_int$0$0({2}SI:U),E,0,0
S:G$ranger_char0$0$0({1}SC:U),E,0,0
S:G$ranger_char1$0$0({2}SI:U),E,0,0
S:G$new_heading$0$0({1}SC:U),E,0,0
S:G$new_range$0$0({1}SC:U),E,0,0
S:G$counts$0$0({2}SI:U),E,0,0
S:G$comp_addr$0$0({1}SC:U),E,0,0
S:G$comp_Data_char$0$0({1}DA1d,SC:U),E,0,0
S:G$comp_Data_int$0$0({2}DA2d,SC:U),E,0,0
S:G$range_addr$0$0({1}SC:U),E,0,0
S:G$range_Data_char0$0$0({1}DA1d,SC:U),E,0,0
S:G$range_Data_char1$0$0({1}DA1d,SC:U),E,0,0
S:G$ping_addr$0$0({1}SC:U),E,0,0
S:G$ping_Data$0$0({1}DA1d,SC:U),E,0,0
S:LLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN.lcd_print$text$1$76({80}DA80d,SC:U),F,0,0
...
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_3$0$0({41}DA41d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_4$0$0({42}DA42d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_5$0$0({41}DA41d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_6$0$0({41}DA41d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_7$0$0({37}DA37d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_8$0$0({46}DA46d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_9$0$0({62}DA62d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_10$0$0({45}DA45d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_11$0$0({67}DA67d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_12$0$0({45}DA45d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_13$0$0({61}DA61d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_14$0$0({45}DA45d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_15$0$0({72}DA72d,SC:S),D,0,0
S:FLITEC_HW10_Paul_McKee_Philip_HODDINOTT_BRIAN$__str_16$0$0({56}DA56d,SC:S),D,0,0
